...
MAC_TEAMS: tuple[Team, ...] = (
    ...
    Team("Massachusetts",     api_lookup_name="UMass",         conference="MAC", conference_abbr="MAC"),
    Team("Miami (OH)",        api_lookup_name="Miami OH",      conference="MAC", conference_abbr="MAC"),
...
AAC_TEAMS: tuple[Team, ...] = (
    Team("Army",          api_lookup_name="Army",          conference="AAC", conference_abbr="AAC"),
    Team("Charlotte",     api_lookup_name="Charlotte",     conference="AAC", conference_abbr="AAC"),
    Team("East Carolina", api_lookup_name="East Carolina", conference="AAC", conference_abbr="AAC"),
    Team("FAU",           api_lookup_name="FAU",           conference="AAC", conference_abbr="AAC"),
    Team("Memphis",       api_lookup_name="Memphis",       conference="AAC", conference_abbr="AAC"),
    Team("Navy",          api_lookup_name="Navy",          conference="AAC", conference_abbr="AAC"),
    Team("North Texas",   api_lookup_name="North Texas",   conference="AAC", conference_abbr="AAC"),
    Team("Rice",          api_lookup_name="Rice",          conference="AAC", conference_abbr="AAC"),
    ...
    Team("UAB",           api_lookup_name="UAB",           conference="AAC", conference_abbr="AAC"),
    Team("UTSA",          api_lookup_name="UTSA",          conference="AAC", conference_abbr="AAC"),
)
...
FBS_INDEPENDENTS_TEAMS: tuple[Team, ...] = (
    Team("Notre Dame",  api_lookup_name="Notre Dame", conference="FBS Independents", conference_abbr="Ind"),
    Team("UConn",       api_lookup_name="UConn",      conference="FBS Independents", conference_abbr="Ind"),
)

# --- FBS Group of 5 ---

MOUNTAIN_WEST_TEAMS: tuple[Team, ...] = (
    Team("Air Force",       api_lookup_name="Air Force",   conference="Mountain West", conference_abbr="MWC"),
    Team("Boise State",     api_lookup_name="Boise St",    conference="Mountain West", conference_abbr="MWC"),
    Team("Colorado State",  api_lookup_name="Colorado St", conference="Mountain West", conference_abbr="MWC"),
    Team("Fresno State",    api_lookup_name="Fresno St",   conference="Mountain West", conference_abbr="MWC"),
    Team("Hawai'i",         api_lookup_name="Hawai'i",     conference="Mountain West", conference_abbr="MWC"),
    Team("Nevada",          api_lookup_name="Nevada",      conference="Mountain West", conference_abbr="MWC"),
    Team("New Mexico",      api_lookup_name="New Mexico",  conference="Mountain West", conference_abbr="MWC"),
    Team("San Diego State", api_lookup_name="San Diego St",conference="Mountain West", conference_abbr="MWC"),
    Team("San Jos\u00e9 State", api_lookup_name="San Jos\u00e9 St", conference="Mountain West", conference_abbr="MWC"),
    Team("UNLV",            api_lookup_name="UNLV",        conference="Mountain West", conference_abbr="MWC"),
    Team("Utah State",      api_lookup_name="Utah State",  conference="Mountain West", conference_abbr="MWC"),
    Team("Wyoming",         api_lookup_name="Wyoming",     conference="Mountain West", conference_abbr="MWC"),
)

SUN_BELT_TEAMS: tuple[Team, ...] = (
    Team("Appalachian State",  api_lookup_name="App State",      conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Arkansas State",     api_lookup_name="Arkansas St",    conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Coastal Carolina",   api_lookup_name="Coastal",        conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Georgia Southern",   api_lookup_name="GA Southern",    conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Georgia State",      api_lookup_name="Georgia St",     conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("James Madison",      api_lookup_name="James Madison",  conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Louisiana",          api_lookup_name="Louisiana",      conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Marshall",           api_lookup_name="Marshall",       conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Old Dominion",       api_lookup_name="Old Dominion",   conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("South Alabama",      api_lookup_name="South Alabama",  conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Southern Miss",      api_lookup_name="Southern Miss",  conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Texas State",        api_lookup_name="Texas St",       conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("Troy",               api_lookup_name="Troy",           conference="Sun Belt", conference_abbr="Sun Belt"),
    Team("UL Monroe",          api_lookup_name="UL Monroe",      conference="Sun Belt", conference_abbr="Sun Belt"),
)

CUSA_TEAMS: tuple[Team, ...] = (
    Team("Delaware",         api_lookup_name="Delaware",       conference="Conference USA", conference_abbr="CUSA"),
    Team("FIU",              api_lookup_name="FIU",            conference="Conference USA", conference_abbr="CUSA"),
    Team("Jacksonville State",api_lookup_name="Jax State",    conference="Conference USA", conference_abbr="CUSA"),
    Team("Kennesaw State",   api_lookup_name="Kennesaw St",    conference="Conference USA", conference_abbr="CUSA"),
    Team("Liberty",          api_lookup_name="Liberty",        conference="Conference USA", conference_abbr="CUSA"),
    Team("Louisiana Tech",   api_lookup_name="Louisiana Tech", conference="Conference USA", conference_abbr="CUSA"),
    Team("Middle Tennessee", api_lookup_name="MTSU",           conference="Conference USA", conference_abbr="CUSA"),
    Team("Missouri State",   api_lookup_name="Missouri St",    conference="Conference USA", conference_abbr="CUSA"),
    Team("New Mexico State", api_lookup_name="New Mexico St",  conference="Conference USA", conference_abbr="CUSA"),
    Team("Sam Houston",      api_lookup_name="Sam Houston",    conference="Conference USA", conference_abbr="CUSA"),
    Team("UTEP",             api_lookup_name="UTEP",           conference="Conference USA", conference_abbr="CUSA"),
    Team("Western Kentucky", api_lookup_name="Western KY",     conference="Conference USA", conference_abbr="CUSA"),
)

# --- FCS Conferences ---

BIG_SKY_TEAMS: tuple[Team, ...] = (
    Team("Cal Poly",         api_lookup_name="Cal Poly",      conference="Big Sky", conference_abbr="Big Sky"),
    Team("Eastern Washington",api_lookup_name="E Washington", conference="Big Sky", conference_abbr="Big Sky"),
    Team("Idaho State",      api_lookup_name="Idaho St",      conference="Big Sky", conference_abbr="Big Sky"),
    Team("Idaho",            api_lookup_name="Idaho",         conference="Big Sky", conference_abbr="Big Sky"),
    Team("Montana",          api_lookup_name="Montana",       conference="Big Sky", conference_abbr="Big Sky"),
    Team("Montana State",    api_lookup_name="Montana St",    conference="Big Sky", conference_abbr="Big Sky"),
    Team("Northern Arizona", api_lookup_name="N Arizona",     conference="Big Sky", conference_abbr="Big Sky"),
    Team("Northern Colorado",api_lookup_name="N Colorado",    conference="Big Sky", conference_abbr="Big Sky"),
    Team("Portland State",   api_lookup_name="Portland St",   conference="Big Sky", conference_abbr="Big Sky"),
    Team("Sacramento State", api_lookup_name="Sacramento St", conference="Big Sky", conference_abbr="Big Sky"),
    Team("UC Davis",         api_lookup_name="UC Davis",      conference="Big Sky", conference_abbr="Big Sky"),
    Team("Weber State",      api_lookup_name="Weber St",      conference="Big Sky", conference_abbr="Big Sky"),
)

CAA_TEAMS: tuple[Team, ...] = (
    Team("Bryant",           api_lookup_name="Bryant",         conference="CAA Football", conference_abbr="CAA"),
    Team("Campbell",         api_lookup_name="Campbell",       conference="CAA Football", conference_abbr="CAA"),
    Team("Elon",             api_lookup_name="Elon",           conference="CAA Football", conference_abbr="CAA"),
    Team("Hampton",          api_lookup_name="Hampton",        conference="CAA Football", conference_abbr="CAA"),
    Team("Maine",            api_lookup_name="Maine",          conference="CAA Football", conference_abbr="CAA"),
    Team("Monmouth",         api_lookup_name="Monmouth",       conference="CAA Football", conference_abbr="CAA"),
    Team("New Hampshire",    api_lookup_name="New Hampshire",  conference="CAA Football", conference_abbr="CAA"),
    Team("NC A&T",           api_lookup_name="NC A&T",         conference="CAA Football", conference_abbr="CAA"),
    Team("Rhode Island",     api_lookup_name="Rhode Island",   conference="CAA Football", conference_abbr="CAA"),
    Team("Stony Brook",      api_lookup_name="Stony Brook",    conference="CAA Football", conference_abbr="CAA"),
    Team("Towson",           api_lookup_name="Towson",         conference="CAA Football", conference_abbr="CAA"),
    Team("UAlbany",          api_lookup_name="UAlbany",        conference="CAA Football", conference_abbr="CAA"),
    Team("Villanova",        api_lookup_name="Villanova",      conference="CAA Football", conference_abbr="CAA"),
    Team("William & Mary",   api_lookup_name="William & Mary", conference="CAA Football", conference_abbr="CAA"),
)

MEAC_TEAMS: tuple[Team, ...] = (
    Team("Delaware State",         api_lookup_name="Delaware St",  conference="MEAC", conference_abbr="MEAC"),
    Team("Howard",                 api_lookup_name="Howard",       conference="MEAC", conference_abbr="MEAC"),
    Team("Morgan State",           api_lookup_name="Morgan St",    conference="MEAC", conference_abbr="MEAC"),
    Team("Norfolk State",          api_lookup_name="Norfolk St",   conference="MEAC", conference_abbr="MEAC"),
    Team("North Carolina Central", api_lookup_name="NC Central",   conference="MEAC", conference_abbr="MEAC"),
    Team("South Carolina State",   api_lookup_name="SC State",     conference="MEAC", conference_abbr="MEAC"),
)

MVFC_TEAMS: tuple[Team, ...] = (
    Team("Illinois State",    api_lookup_name="Illinois St",   conference="MVFC", conference_abbr="MVFC"),
    Team("Indiana State",     api_lookup_name="Indiana St",    conference="MVFC", conference_abbr="MVFC"),
    Team("Murray State",      api_lookup_name="Murray St",     conference="MVFC", conference_abbr="MVFC"),
    Team("North Dakota",      api_lookup_name="North Dakota",  conference="MVFC", conference_abbr="MVFC"),
    Team("North Dakota State",api_lookup_name="N Dakota St",   conference="MVFC", conference_abbr="MVFC"),
    Team("Northern Iowa",     api_lookup_name="Northern Iowa", conference="MVFC", conference_abbr="MVFC"),
    Team("South Dakota",      api_lookup_name="South Dakota",  conference="MVFC", conference_abbr="MVFC"),
    Team("South Dakota State",api_lookup_name="S Dakota St",   conference="MVFC", conference_abbr="MVFC"),
    Team("Southern Illinois", api_lookup_name="S Illinois",    conference="MVFC", conference_abbr="MVFC"),
    Team("Youngstown State",  api_lookup_name="Youngstown St", conference="MVFC", conference_abbr="MVFC"),
)

NEC_TEAMS: tuple[Team, ...] = (
    Team("Central Connecticut",  api_lookup_name="C Connecticut",  conference="NEC", conference_abbr="NEC"),
    Team("Duquesne",             api_lookup_name="Duquesne",       conference="NEC", conference_abbr="NEC"),
    Team("LIU",                  api_lookup_name="Long Island",    conference="NEC", conference_abbr="NEC"),
    Team("Mercyhurst",           api_lookup_name="Mercyhurst",     conference="NEC", conference_abbr="NEC"),
    Team("New Haven",            api_lookup_name="New Haven",      conference="NEC", conference_abbr="NEC"),
    Team("Robert Morris",        api_lookup_name="Robert Morris",  conference="NEC", conference_abbr="NEC"),
    Team("Saint Francis",        api_lookup_name="Saint Francis",  conference="NEC", conference_abbr="NEC"),
    Team("Stonehill",            api_lookup_name="Stonehill",      conference="NEC", conference_abbr="NEC"),
    Team("Wagner",               api_lookup_name="Wagner",         conference="NEC", conference_abbr="NEC"),
)

OVC_BIG_SOUTH_TEAMS: tuple[Team, ...] = (
    Team("Charleston Southern",      api_lookup_name="Charleston So",  conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("Eastern Illinois",         api_lookup_name="E Illinois",     conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("Gardner-Webb",             api_lookup_name="Gardner-Webb",   conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("Lindenwood",               api_lookup_name="Lindenwood",     conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("Southeast Missouri State", api_lookup_name="SE Missouri",    conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("Tennessee State",          api_lookup_name="Tennessee St",   conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("Tennessee Tech",           api_lookup_name="Tennessee Tech", conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("UT Martin",                api_lookup_name="UT Martin",      conference="OVC-Big South", conference_abbr="OVC-BS"),
    Team("Western Illinois",         api_lookup_name="W Illinois",     conference="OVC-Big South", conference_abbr="OVC-BS"),
)

PATRIOT_TEAMS: tuple[Team, ...] = (
    Team("Bucknell",    api_lookup_name="Bucknell",   conference="Patriot League", conference_abbr="Patriot"),
    Team("Colgate",     api_lookup_name="Colgate",    conference="Patriot League", conference_abbr="Patriot"),
    Team("Fordham",     api_lookup_name="Fordham",    conference="Patriot League", conference_abbr="Patriot"),
    Team("Georgetown",  api_lookup_name="Georgetown", conference="Patriot League", conference_abbr="Patriot"),
    Team("Holy Cross",  api_lookup_name="Holy Cross", conference="Patriot League", conference_abbr="Patriot"),
    Team("Lafayette",   api_lookup_name="Lafayette",  conference="Patriot League", conference_abbr="Patriot"),
    Team("Lehigh",      api_lookup_name="Lehigh",     conference="Patriot League", conference_abbr="Patriot"),
    Team("Richmond",    api_lookup_name="Richmond",   conference="Patriot League", conference_abbr="Patriot"),
)

PIONEER_TEAMS: tuple[Team, ...] = (
    Team("Butler",          api_lookup_name="Butler",          conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Davidson",        api_lookup_name="Davidson",        conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Dayton",          api_lookup_name="Dayton",          conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Drake",           api_lookup_name="Drake",           conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Marist",          api_lookup_name="Marist",          conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Morehead State",  api_lookup_name="Morehead St",     conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Presbyterian",    api_lookup_name="Presbyterian",    conference="Pioneer Football League", conference_abbr="PFL"),
    Team("San Diego",       api_lookup_name="San Diego",       conference="Pioneer Football League", conference_abbr="PFL"),
    Team("St. Thomas",      api_lookup_name="St Thomas (MN)",  conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Stetson",         api_lookup_name="Stetson",         conference="Pioneer Football League", conference_abbr="PFL"),
    Team("Valparaiso",      api_lookup_name="Valparaiso",      conference="Pioneer Football League", conference_abbr="PFL"),
)

SOCON_TEAMS: tuple[Team, ...] = (
    Team("Chattanooga",    api_lookup_name="Chattanooga",  conference="SoCon", conference_abbr="SoCon"),
    Team("ETSU",           api_lookup_name="ETSU",         conference="SoCon", conference_abbr="SoCon"),
    Team("Furman",         api_lookup_name="Furman",       conference="SoCon", conference_abbr="SoCon"),
    Team("Mercer",         api_lookup_name="Mercer",       conference="SoCon", conference_abbr="SoCon"),
    Team("Samford",        api_lookup_name="Samford",      conference="SoCon", conference_abbr="SoCon"),
    Team("The Citadel",    api_lookup_name="The Citadel",  conference="SoCon", conference_abbr="SoCon"),
    Team("VMI",            api_lookup_name="VMI",          conference="SoCon", conference_abbr="SoCon"),
    Team("Western Carolina",api_lookup_name="W Carolina",  conference="SoCon", conference_abbr="SoCon"),
    Team("Wofford",        api_lookup_name="Wofford",      conference="SoCon", conference_abbr="SoCon"),
)

SOUTHLAND_TEAMS: tuple[Team, ...] = (
    Team("East Texas A&M",        api_lookup_name="E Texas A&M",    conference="Southland", conference_abbr="Southland"),
    Team("Houston Christian",     api_lookup_name="Hou Christian",  conference="Southland", conference_abbr="Southland"),
    Team("Incarnate Word",        api_lookup_name="Incarnate Word", conference="Southland", conference_abbr="Southland"),
    Team("Lamar",                 api_lookup_name="Lamar",          conference="Southland", conference_abbr="Southland"),
    Team("McNeese",               api_lookup_name="McNeese",        conference="Southland", conference_abbr="Southland"),
    Team("Nicholls",              api_lookup_name="Nicholls",       conference="Southland", conference_abbr="Southland"),
    Team("Northwestern State",    api_lookup_name="N'Western St",   conference="Southland", conference_abbr="Southland"),
    Team("SE Louisiana",          api_lookup_name="SE Louisiana",   conference="Southland", conference_abbr="Southland"),
    Team("Stephen F. Austin",     api_lookup_name="SF Austin",      conference="Southland", conference_abbr="Southland"),
    # UT Rio Grande Valley is in the Southland conference but has no ESPN logo — excluded
)

SWAC_TEAMS: tuple[Team, ...] = (
    Team("Alabama A&M",            api_lookup_name="Alabama A&M",    conference="SWAC", conference_abbr="SWAC"),
    Team("Alabama State",          api_lookup_name="Alabama St",     conference="SWAC", conference_abbr="SWAC"),
    Team("Alcorn State",           api_lookup_name="Alcorn St",      conference="SWAC", conference_abbr="SWAC"),
    Team("Arkansas-Pine Bluff",    api_lookup_name="AR-Pine Bluff",  conference="SWAC", conference_abbr="SWAC"),
    Team("Bethune-Cookman",        api_lookup_name="Bethune",        conference="SWAC", conference_abbr="SWAC"),
    Team("Florida A&M",            api_lookup_name="Florida A&M",    conference="SWAC", conference_abbr="SWAC"),
    Team("Grambling",              api_lookup_name="Grambling",      conference="SWAC", conference_abbr="SWAC"),
    Team("Jackson State",          api_lookup_name="Jackson St",     conference="SWAC", conference_abbr="SWAC"),
    Team("Mississippi Valley State",api_lookup_name="Miss Valley St",conference="SWAC", conference_abbr="SWAC"),
    Team("Prairie View A&M",       api_lookup_name="Prairie View",   conference="SWAC", conference_abbr="SWAC"),
    Team("Southern",               api_lookup_name="Southern",       conference="SWAC", conference_abbr="SWAC"),
    Team("Texas Southern",         api_lookup_name="Texas Southern", conference="SWAC", conference_abbr="SWAC"),
)

UAC_TEAMS: tuple[Team, ...] = (
    Team("Abilene Christian",  api_lookup_name="Abilene Chrstn", conference="United Athletic Conference", conference_abbr="UAC"),
    Team("Austin Peay",        api_lookup_name="Austin Peay",    conference="United Athletic Conference", conference_abbr="UAC"),
    Team("Central Arkansas",   api_lookup_name="C Arkansas",     conference="United Athletic Conference", conference_abbr="UAC"),
    Team("Eastern Kentucky",   api_lookup_name="E Kentucky",     conference="United Athletic Conference", conference_abbr="UAC"),
    Team("North Alabama",      api_lookup_name="North Alabama",  conference="United Athletic Conference", conference_abbr="UAC"),
    Team("Southern Utah",      api_lookup_name="Southern Utah",  conference="United Athletic Conference", conference_abbr="UAC"),
    Team("Tarleton State",     api_lookup_name="Tarleton St",    conference="United Athletic Conference", conference_abbr="UAC"),
    Team("Utah Tech",          api_lookup_name="Utah Tech",      conference="United Athletic Conference", conference_abbr="UAC"),
    Team("West Georgia",       api_lookup_name="West Georgia",   conference="United Athletic Conference", conference_abbr="UAC"),
)

FCS_INDEPENDENTS_TEAMS: tuple[Team, ...] = (
    Team("Merrimack",    api_lookup_name="Merrimack",    conference="FCS Independents", conference_abbr="Ind"),
    Team("Sacred Heart", api_lookup_name="Sacred Heart", conference="FCS Independents", conference_abbr="Ind"),
)
